  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarText">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link <?=$link_nav_home?>" href="<?=$root?>"><i class="fas fa-home"></i> Home</a>
        </li>
        <li class="nav-item">
          <a class="nav-link <?=$link_nav_about?>" href="<?=$root?>about/"><i class="fas fa-id-badge"></i> About</a>
        </li>
        <li class="nav-item">
          <a class="nav-link <?=$link_nav_blog?>" href="<?=$blog?>"><i class="fas fa-blog"></i> Blog</a>
        </li>
        <div class="dropdown nav-item">
          ...
          <i class="fas fa-network-wired"></i> Category
          </a>
